...
\begin{document}
    ...
    \section{Feature Library}
        ...
        \subsection{lipsum and strip}
            ...
            The package \texttt{lipsum} provides blind text for testing layout design and the \texttt{strip} environment need to measure current page typography to design how to place the cross part, so if the current page is not 
\end{document}