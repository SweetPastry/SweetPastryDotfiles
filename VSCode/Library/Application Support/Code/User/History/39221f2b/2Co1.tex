...
\begin{document}
    ...
    \section{Feature Library}
        ...
        \subsection{lipsum and strip}
            ...
            The package \texttt{lipsum} provides blind text for testing layout design and the \texttt{strip} environment need to measure current page typography to design how to place the cross part, so if the current page is not fitable to do this, for example, too many figure or less characters to devide, it may cause weired bugs.
\end{document}