\section*{Problem 21}
    ...
    \node[anchor=north west,color=gray!67, yshift=-0.75em, xshift=4em] (jtext) at ($(Kepler1.south)!0.5!(Kepler2.south)$) {aaa};
    \draw[<->,color=gray!57] (Kepler1.south east) |- (jtext.north) -| (Kepler2.east);
    \end{tikzpicture}