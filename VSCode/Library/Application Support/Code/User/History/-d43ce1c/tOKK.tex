\section*{Problem 21}
    ...
    \node[anchor=north west,color=gray!67, yshift=-0em, xshift=4em] (jtext) at ($(Kepler1.south)!0.5!(Kepler2.south)$) {In Kepler potential case,\\ this two part conpensate to 0.};
