function Q3()
    ...
    uicontrol(
        ...
        'Callback', @(src, event) buttonCallbackRock('Button 1 Pressed')
    );
    
    uicontrol('Parent', hFig, 'Style', 'pushbutton', 'String', 'Scissor', ...
              'Position', [50, 60, 70, 30], 'Callback', @(src, event) buttonCallback('Button 2 Pressed'));
    
    uicontrol('Parent', hFig, 'Style', 'pushbutton', 'String', 'Paper', ...
