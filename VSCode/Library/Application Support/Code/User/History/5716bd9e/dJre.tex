...
\section{Document}
    ...
    \begin{enumerate}
        \item \texttt{\textbackslash frontmatter}: In origin \LaTeX, this command is play a role as global compiliation flow control, but come into effect at a later stage. As a result, it may not be deemed as suitable to be capsulated. \texttt{spBook} has capsulated some other 
