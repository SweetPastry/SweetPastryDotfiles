\begin{titlepage}
	\begin{tikzpicture}[remember picture, overlay, pencildraw/.style={
		...
		\node[anchor=west] at ([yshift=-20pt] author.east) {\fontsize{18}{18}\CJKfamily{cover-author-font}Coverpage code \textbf{heavily} based on \href{https://github.com/wenweili/AlJabr-1/blob/master/coverpage.tex}{Li Wen-wei} and \href{https://texample.net/parallelepiped/}{Axel Pavillet}};
