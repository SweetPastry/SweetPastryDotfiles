\begin{titlepage}
	\begin{tikzpicture}[remember picture, overlay, pencildraw/.style={
		...
		\node[anchor=west] (author) at ([yshift=-5em, xshift=-4pt] volume.south west) {\fontsize{12}{12}林海轩};
		\node[anchor=west] at ([xshift=-60pt, yshift=-15pt] author.east) {\fontsize{12}{12}数学物理方法讲义};
